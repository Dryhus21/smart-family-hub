    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          <p className="mt-1 text-sm text-slate-600">Selamat datang kembali!</p>
          ...
          <p className="mt-6 text-center text-sm text-slate-600">
            Belum punya akun?{" "}
            <Link href="/register" className="font-medium text-indigo-600 hover:underline">Daftar sekarang</Link>
          </p>
        </div>
      </div>
    </div>
